---
date: '2021-01-31'
title: 'Maldives 2020 - a diving extravaganza'
description: 'diving with sharks and rays - a photo and video Essay'
...
import mothership_evening from './media/mothership_evening.mp4'

import coffee from './media/coffee.gif'
...
import eagle_ray_flying from './media/eagle_ray_flying.gif'
...
import nurse_shark_night_1 from './media/nurse_shark_night_1.gif'
...
<ImageGrid caption="" photos={[{src: travel_ok, width: 768,height: 1024}, {src: maldives_directions, width: 900,height: 1200}]}/>

### Life on Liveaboard

We stayed on the [Soleil 2](https://www.blueksafari.com.mv/liveaboard/Soleil-2) for a week from 26th December to 2nd January. During these 7 days, we covered most of the best dive sites in the Northern and Central Maldives. Usually, the Liveaboard housed 30 guests but due to COVID, we had 18 guests on the boat.
<ImageGrid caption="" photos={[{src: soleil_2_yacht, width: 1600,height: 900}]}/>
...
<ImageGrid caption="" photos={[{src: dhoani_dingi, width: 1600,height: 894}]}/>
...
<ImageGrid caption="" photos={[{src: food_1, width: 1024,height: 768}, {src: food_3, width: 720,height: 956}, {src: food_2, width: 1024,height: 768}]}/>
...
<video poster={poster_sandbank} src={sandbank_visit} muted controls width="100%" muted></video>
...
<ImageGrid caption="" photos={[{src: dive_briefing_tv, width: 1280,height: 795}, {src: dive_briefing, width: 1280,height: 891}]}/>

After the briefing, we transferred to the dive _Dhoani_ to **Suit Up!**

<ImageGrid caption="" photos={[{src: suit_up, width: 880,height: 1200}]}/>
...
<ImageGrid caption={<span>DM teaching us new tricks while we wait on our <a href="https://www.divein.com/guide/safety-stop-why-do-i-need-to-do-it/">Safety Stop</a></span>} photos={[{src: safety_stop, width: 1600,height: 877}]}/>
...
<ImageGrid caption="" photos={[{src: diving_log, width: 1600,height: 1200}]}/>
...
<ImageGrid caption="" photos={[{src: coffee, width: 1024,height: 576}, {src: lazy_day, width: 1600,height: 904}, {src: catching_fish, width: 1204,height: 685}]}/>

<video poster={poster_evening} src={mothership_evening} muted controls width="100%" muted></video>
...
<ImageGrid caption="" photos={[{src: diving_calendar, width: 1600,height: 857}]}/>
...
<ImageGrid caption="" photos={[{src: nurse_shark_snorkel_1, width: 1601,height: 907}, {src: nurse_shark_snorkel_3, width: 1600,height: 896}, {src: nurse_shark_snorkel_2, width: 1200,height: 670}]}/>
...
<ImageGrid caption="" photos={[{src: nurse_shark_night_2, width: 1600,height: 894}, {src: nurse_shark_night_1, width: 800,height: 449}]}/>
...
<ImageGrid caption="" photos={[{src: watching_sharks, width: 1600,height: 887}, {src: sharks_1, width: 1600,height: 893}]}/>

Here’s a **White Tip Shark** up close.
<ImageGrid caption="" photos={[{src: shark_black_tip, width: 1600,height: 894}]}/>
...
<ImageGrid caption="" photos={[{src: whale_shark, width: 1600,height: 894}]}/>
...
<ImageGrid caption="" photos={[{src: tiger_shark, width: 1600,height: 891}]}/>
...
<ImageGrid caption="" photos={[{src: stingray_smiling, width: 1600,height: 899}]}/>
...
<ImageGrid caption="" photos={[{src: eagle_ray_flying, width: 600,height: 337}, {src: flying_eagle_ray, width: 1600,height: 900}]}/>
...
<video poster={poster_manta_dance} src={manta_show} muted controls width="100%" muted></video>

<!-- <ImageGrid caption="" photos={[{src: manta_flying, width: 1600,height: 897}]}/>-->
...
<ImageGrid caption="" photos={[{src: diving_week_calendar, width: 1600,height: 1200}, {src: dive_watch, width: 1012,height: 1242}, {src: dive_crew, width: 1600,height: 1200}]}/>
...
<video poster="" src={goodbye_2020} muted controls width="100%" muted></video>

and welcome 2021
<ImageGrid caption="" photos={[{src: happy_new_year_2021, width: 1600,height: 897}]}/>
