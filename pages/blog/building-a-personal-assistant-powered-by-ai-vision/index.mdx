...
<MediaGrid caption={<span>Vision App and Chat Interface powered by <a href="https://cloud.google.com/dialogflow" target="new">Dialogflow</a> and <a href="https://beta.openai.com/" target="new">OpenAI</a></span>} photos={[{src: vision_app_icon, width: 730,height: 1600}, {src: vision_app_video, poster: vision_app, width: 646,height: 1400}]}/>
