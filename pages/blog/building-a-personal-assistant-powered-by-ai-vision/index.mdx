...
keywords: 'Assistant,digital assistant,AI,JARVIS,Vision'
---
...
import vision_jokes from './media/vision_jokes.mp4'
import vision_app from './media/vision_app.jpg'
...
- **Mobile App**<br/>
  ...
  The app helps me relay information in form of chat and voice commands. There are custom widgets that helps play our home playlists on Spotify and interact with all the Smart lamps connected in our home.
...
- **Natural Language Voice Interface**<br/>
  ...
  It uses machine learning to extract the intent behind the given commands. These intents then are mapped to the various commands and actions.
...
<MediaGrid caption="Vision App Interface" photos={[{src: vision_app_icon, width: 1125,height: 2436}, {src: vision_jokes, poster: vision_app, width: 1125,height: 2436}]}/>
...
- **Breathwork** <br/>
  Runs a Breathing exercise animation on the screen. Helps calm down
...
<MediaGrid caption={'Vision Schematics'} photos={[{src: vision_schematics, width: 2832,height: 1470}]}/>
