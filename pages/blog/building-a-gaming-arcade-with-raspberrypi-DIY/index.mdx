...
import image_flashing1 from './images/flashing-1.jpg'
import image_flashing2 from './images/flashing-2.jpg'
import image_ipScan from './images/rpi-ip-scan.jpg'
import image_rpi_ssh from './images/rpi-ssh.jpg'
import image_rpi_logo from './images/retropie-logo.png'
import image_thats_all from './images/thats-all-folks.gif'

export const meta = articles[6]
...
<img src={image_rpi_logo} alt="RetroPie logo" />
...
<ImageGrid
photos={[{src:image_flashing1, width: 1600, height: 965}, {src:image_flashing2,width: 1600, height: 965}]}  
...
<ImageGrid
photos={[{src:image_ipScan, width: 1837, height: 1295},{src:image_rpi_ssh, width: 1414, height: 1062}]}  
...
<img src={image_thats_all} alt="That's all folks"/>

---

If you like building hobby projects and are new to the **RaspberryPI** world, I would seriously recommend investing some time playing around with it.
There are a [ton](https://howchoo.com/g/ywrkztg1nda/raspberry-pi-projects) of amazing projects which you can build with RPI.
