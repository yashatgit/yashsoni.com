...
//     //Resize to 28X28
//     var tfResizedImage = tf.image.resizeBilinear(tfImage, [28, 28]).toFloat();
...
//     const normalized = tf.scalar(1.0).sub(tfResizedImage.div(tf.scalar(255.0)));
...
const predictNumber = () => {
  ...
  //const mbb = getMinBox()
  const mbb = { min: { x: 0, y: 0 }, max: { x: CANVAS_SIze, y: CANVAS_SIze } };
