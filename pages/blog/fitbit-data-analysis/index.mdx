...
excerpt: 'Physical activity trackers have become a multimillion-dollar product category. I have had my fair share of fancy trackers, starting early from...'
keywords: 'data science,fitbit,fitness trackers,data health,healthy living,sleep analyis,python,jupyter notebook'
---

import MediaGrid from '../../../components/mediaGrid'

import data_idea from './media/data-has-a-better-idea.jpg'
import activity_analysis from './media/activity_analysis.jpg'
import calorie_analysis from './media/calorie_analysis.jpg'
import corelation_matrix from './media/corelation_matrix.jpg'
import datafetch_1 from './media/datafetch_1.jpg'
import datafetch_2 from './media/datafetch_2.jpg'
import fitbit_1 from './media/fitbit_1.jpg'
import fitbit_2 from './media/fitbit_2.jpg'
import fitbit_3 from './media/fitbit_3.jpg'
import sleep_1 from './media/sleep_1.jpg'
import sleep_2 from './media/sleep_2.jpg'
import sleep_3 from './media/sleep_3.jpg'
import sleep_4 from './media/sleep_4.jpg'
import experimentation_cycle from './media/experimentation_cycle.png'
import sleep_corelation from './media/sleep_corelation.jpg'
import sleep_week from './media/sleep_week.jpg'

<MediaGrid
photos={[{src:data_idea, width: '4000', height: '3000'}]}  
caption={<span>Photo Credit: <a href="https://unsplash.com/@franki">Franki Chamaki</a></span>}
/>
...
<MediaGrid photos={[{src: fitbit_1, width: 800,height: 1292}, {src: fitbit_2, width: 800,height: 1292}, {src: fitbit_3, width: 800,height: 1292}]}
...
<MediaGrid photos={[{src: experimentation_cycle, width: 1162 ,height:  740}]}
caption={<span>The experimentation cycle <a href="https://thehealthsciencesacademy.org/health-tips/how-to-conduct-an-effective-self-experiment/">src</a></span>}
/>
...
<MediaGrid rowHeight={200} photos={[{src: datafetch_1, width: 802,height: 374}, {src: datafetch_2, width: 2010,height: 654}]} caption="Sample data grabber session and the corresponding Pandas DataFrame"/>
...
<MediaGrid caption="Activity Analysis" photos={[{src: activity_analysis, width: 2026,height: 668}]}/>
...
<MediaGrid caption="Calorie Analysis" photos={[{src: calorie_analysis, width: 1776,height: 910}]}/>
...
<MediaGrid photos={[{src: corelation_matrix, width: 1296,height: 1240}]}/>
...
<MediaGrid caption="" photos={[{src: sleep_1, width: 1986,height: 832}]}/>
<MediaGrid caption="" photos={[{src: sleep_2, width: 1990,height: 630}]}/>
...
<MediaGrid caption="" photos={[{src: sleep_3, width: 632,height: 600}, {src: sleep_4, width: 1428,height: 726}]}/>
...
<MediaGrid caption="" photos={[{src: sleep_corelation, width: 1334,height: 1134}]}/>
...
<MediaGrid caption="" photos={[{src: sleep_week, width: 804,height: 514}]}/>
