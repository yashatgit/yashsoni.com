...
```bash
npm run #press tab
build   dev   export  imageoptim  imageoptim:gif  imageoptim:jpg  imageoptim:png  lint  prettier  start  test
```
...
- [https://corgibytes.com/blog/2017/04/18/npm-tips/](https://corgibytes.com/blog/2017/04/18/npm-tips/)
