...
Unlike other traditional programming languages however, for a long time, JavaScript didn't provide developers with the means to import such modules of code in a clean, organized manner.

This didn't stop the community, and they created impressive work-arounds. Looking back from 2020, following are the most used module loading patterns used by the developers:
...
- `exports` is a special object: anything put in it will get exported as a public element
...
Fortunately, the ECMA team behind the standardization of JavaScript decided to tackle the issue of modules. We finally have a standard to define module in Javascript 
which is syntactically pleasing and compatible with both synchronous and asynchronous modes of operation.
