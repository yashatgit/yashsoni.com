    ...
    [4],
    {
                                            ...
                                            if ('string' === typeof d || (d.content && 'string' === typeof d.content)) {
                                                ...
                                                if (m > -1) {
                                                    ...
                                                    var f = u.substring(0, m),
                                                        ...
                                                        E = u.substring(m + g.length),
                                                        _ = [];
                                                    f && _.push.apply(_, o([f])),
                                                        _.push(b),
                                                        E && _.push.apply(_, o([E])),
                                                        'string' === typeof d
                                                            ? s.splice.apply(s, [l, 1].concat(_))
                                                            : (d.content = _);
                                                }
                            ...
                            for (var r = [], i = 0; i < t.length; i++) {
                                ...
                                if (
                                    ('string' !== typeof o &&
                                        ('tag' === o.type && o.content[0] && 'tag' === o.content[0].type
                                            ? '</' === o.content[0].content[0].content
                                                ? r.length > 0 &&
                                                  r[r.length - 1].tagName === n(o.content[0].content[1]) &&
                                                  r.pop()
                                                : '/>' === o.content[o.content.length - 1].content ||
                                                  r.push({tagName: n(o.content[0].content[1]), openedBraces: 0})
                                    ...
                                    i < t.length - 1 &&
                                        ...
                                        ((l += n(t[i + 1])), t.splice(i + 1, 1)),
                                        i > 0 &&
                                            ('string' === typeof t[i - 1] || 'plain-text' === t[i - 1].type) &&
                                            ((l = n(t[i - 1]) + l), t.splice(i - 1, 1), i--),
            ...
            function a(e) {
                !(function(e) {
                    var t = /\\\((?:[^()]|\([^()]*\))*\)/.source,
                        ...
                        r = (e.languages.jq = {
                            comment: /#.*/,
                            property: {pattern: RegExp(n.source + /(?=\s*:(?!:))/.source), greedy: !0, inside: a},
                        ...
                        (e.languages.soy = {
                            ...
                            e.hooks.add('before-tokenize', function(t) {
                                ...
                                e.languages['markup-templating'].buildPlaceholders(
                                    ...
                                    function(e) {
                                        return (
                                            '{/literal}' === e && (n = !1), !n && ('{literal}' === e && (n = !0), !0)
                                        );
                                    }
                                );
                            }),
            ...
            (function(t) {
                ...
                (e.exports = g),
                    ...
                    (g.alias = function(e, t) {
                        ...
                        t && ((s = {})[e] = t);
                        for (n in s)
                            for (a = s[n], r = (a = 'string' === typeof a ? [a] : a).length, i = -1; ++i < r; )
                                o[a[i]] = o[n];
                    }),
                        ...
                        if ('Array' === g.util.type(e))
                            return (function(e, t) {
                                var n,
                                    ...
                                    r = e.length,
                                    i = -1;
                                for (; ++i < r; ) '' !== (n = e[i]) && null !== n && void 0 !== n && a.push(n);
                                (i = -1), (r = a.length);
        ...
        '65Hy': function(e, t, n) {
            var a = n('q1tI'),
                ...
                o = n('Bml6'),
                s = r.a.createElement,
                l = i.default.time.withConfig({displayName: 'date__StyledDate', componentId: 'sc-1nzrcqs-0'})(
                    [
                        'color:',
            ...
            t.a = (e) => {
                var {children: t} = e;
                return s(l, {dateTime: Object(o.a)(t)}, Object(o.b)(t));
            };
        },
        '7+hk': function(e, t, n) {
            var a = n('z2ZG'),
            ...
            var d = r.a.createContext({}),
                c = function(e) {
                    var t = r.a.useContext(d),
                        n = t;
                    return e && (n = 'function' === typeof e ? e(t) : s({}, t, {}, e)), n;
                },
                p = function(e) {
                    var t = c(e.components);
                    return r.a.createElement(d.Provider, {value: t}, e.children);
                },
                u = 'mdxType',
                g = {
                    inlineCode: 'code',
                ...
                m = Object(a.forwardRef)(function(e, t) {
                    var n = e.components,
                        ...
                        p = c(n),
                        u = a,
                        m = p[''.concat(o, '.').concat(u)] || p[u] || g[u] || i;
                    return n
                        ? r.a.createElement(m, s({ref: t}, d, {components: n}))
                        : r.a.createElement(m, s({ref: t}, d));
                });
            function f(e, t) {
                var n = arguments,
                    a = t && t.mdxType;
                if ('string' === typeof e || a) {
                    ...
                    (s.originalType = e), (s[u] = 'string' === typeof e ? e : a), (o[1] = s);
                    for (var d = 2; d < i; d++) o[d] = n[d];
                    return r.a.createElement.apply(null, o);
                }
        ...
        BWuY: function(e, t, n) {
            ...
            (e.exports = r), (r.displayName = 'pure'), (r.aliases = []);
        },
        C3kK: function(e, t, n) {
            function a(e) {
                e.languages.rip = {
                ...
                !(function(e) {
                    var t = /\((?:[^()]|\((?:[^()]|\([^()]*\))*\))*\)/.source,
                        ...
                        a = (e.languages.pascaligo = {
                            ...
                            'class-name': [
                                {
                                    pattern: RegExp(/(\btype\s+\w+\s+is\s+)<type>/.source.replace(/<type>/g, n), 'i'),
                                    lookbehind: !0,
                                    inside: null
                                },
                                {pattern: RegExp(/<type>(?=\s+is\b)/.source.replace(/<type>/g, n), 'i'), inside: null},
                                {
                                ...
                                t.forEach(function(t) {
                                    !(function(t, n) {
                                        ...
                                        if (a) {
                                            ...
                                            if (
                                                (r instanceof RegExp && (r = a['doc-comment'] = {pattern: r}),
                                                Array.isArray(r))
                                            )
                                                for (var o = 0, s = r.length; o < s; o++)
                                                    r[o] instanceof RegExp && (r[o] = {pattern: r[o]}), n(r[o]);
                                            else n(r);
                                        }
                                    })(t, function(e) {
        ...
        'G0F+': function(e, t, n) {
            ...
            var a = n('q1tI'),
                ...
                p = i.default.h1.withConfig({displayName: 'text__StyledH1', componentId: 'fjye17-0'})(
                    [
                        '',
                        ';color:',
                ...
                u = i.default.h2.withConfig({displayName: 'text__StyledH2', componentId: 'fjye17-1'})(
                    [
                        '',
                        ';color:',
                ...
                g = i.default.h3.withConfig({displayName: 'text__StyledH3', componentId: 'fjye17-2'})(
                ...
                m =
                    (i.default.h4.withConfig({displayName: 'text__StyledH4', componentId: 'fjye17-3'})(
                    ...
                    (e) => {
                        var {children: t} = e;
                        return d(p, null, Object(l.a)(t));
                    }),
                f = (e) => {
                    var {children: t} = e;
                    return d(u, {id: c(t)}, Object(l.a)(t));
                },
                b = (e) => {
                    var {children: t} = e;
                    return d(g, {id: c(t)}, Object(l.a)(t));
                };
        },
        G73E: function(e, t, n) {
            function a(e) {
            ...
            function a(e) {
                !(function(e) {
                    ...
                    for (
                        ...
                        'RegExp' === e.util.type(r) && (r = e.languages.javascript[a] = {pattern: r});
                        var i = r.inside || {};
        ...
        'O/s9': function(e, t, n) {
            var a = n('YHgv');
            function r(e) {
                e.register(a), (e.languages['t4-vb'] = e.languages['t4-templating'].createT4('visual-basic'));
            }
                    ...
                    (e.languages.markdown = e.languages.extend('markup', {})),
                        ...
                        e.hooks.add('wrap', function(t) {
                            if ('code-block' === t.type) {
                                ...
                                var s = e.languages[n];
                                if (s) {
                                    var l = t.content.value.replace(/&lt;/g, '<').replace(/&amp;/g, '&');
        ...
        WtKE: function(e, t, n) {
            ...
            e.exports = function(e) {
                ...
                if (
                    ...
                    (t = a.textContent).charCodeAt(t.length - 1) === r && 'semi' !== e)
                )
                    return !1;
                return t !== n && t;
            };
                    ...
                    var t = /\blang(?:uage)?-([\w-]+)\b/i,
                        ...
                        a = {
                                    ...
                                    for (var s in t)
                                        if (t.hasOwnProperty(s)) {
                                            ...
                                            var l = t[s],
                                                d = a.util.type(l);
                                            'Object' !== d || i[o(l)]
                                                ? 'Array' !== d || i[o(l)] || ((i[o(l)] = !0), e(l, n, s, i))
                            ...
                            highlightAllUnder: function(e, t, n) {
                                ...
                                for (var i, o = e.querySelectorAll(r.selector), s = 0; (i = o[s++]); )
                                    a.highlightElement(i, !0 === t, r.callback);
                            },
                            highlightElement: function(n, r, i) {
                                for (var o, s = 'none', l = n; l && !t.test(l.className); ) l = l.parentNode;
                                l &&
                                    ((s = (l.className.match(t) || [, 'none'])[1].toLowerCase()), (o = a.languages[s])),
                                    (n.className = n.className.replace(t, '').replace(/\s+/g, ' ') + ' language-' + s),
                                    n.parentNode &&
                                        ((l = n.parentNode),
                                        /pre/i.test(l.nodeName) &&
                                            (l.className =
                                                l.className.replace(t, '').replace(/\s+/g, ' ') + ' language-' + s));
                                var d = {element: n, language: s, grammar: o, code: n.textContent},
                                    c = function(e) {
                                        (d.highlightedCode = e),
                                ...
                                for (var d in n)
                                    if (n.hasOwnProperty(d) && n[d]) {
                                        ...
                                        for (var p = 0; p < c.length; ++p) {
                                            ...
                                            u = u.pattern || u;
                                            for (var S = i, h = o; S < t.length; h += t[S].length, ++S) {
                                                var y = t[S];
                                                if (t.length > e.length) return;
                                                if (!(y instanceof r)) {
                                                    if (f && S != t.length - 1) {
                                                        if (((u.lastIndex = h), !(O = u.exec(e)))) break;
                                                        for (
                                                            var T = O.index + (m ? O[1].length : 0),
                                                                A = O.index + O[0].length,
                                                                I = S,
                                                                N = h,
                                                                R = t.length;
                                                            I < R && (N < A || (!t[I].type && !t[I - 1].greedy));
                                                            ++I
                                                        )
                                                            T >= (N += t[I].length) && (++S, (h = N));
                                                        if (t[S] instanceof r) continue;
                                                        (v = I - S), (y = e.slice(h, N)), (O.index -= h);
                                                    } else {
                                                        u.lastIndex = 0;
                                                        var O = u.exec(y),
                                                            v = 1;
                                                    ...
                                                    if (O) {
                                                        m && (b = O[1] ? O[1].length : 0);
                                                        A = (T = O.index + b) + (O = O[0].slice(b)).length;
                                                        var C = y.slice(0, T),
                                                            w = y.slice(A),
                                                            k = [S, v];
                                                        C && (++S, (h += C.length), k.push(C));
                                                        var L = new r(d, g ? a.tokenize(O, g) : O, E, O, f);
                                                        if (
                                                            (k.push(L),
                                                            w && k.push(w),
                                                            Array.prototype.splice.apply(t, k),
                                                            1 != v && a.matchGrammar(e, t, n, S, h, !0, d),
                                                            s)
                                                        )
                                                            break;
                                                    } else if (s) break;
        ...
        ZKMX: function(e, t, n) {
            ...
            (e.exports = r), (r.displayName = 'ejs'), (r.aliases = []);
        },
        ZONP: function(e, t, n) {
            e.exports = function(e) {
                var t = 'string' === typeof e ? e.charCodeAt(0) : e;
        ...
        ZWk2: function(e, t, n) {
            ...
            e.exports = function(e, t) {
                var n,
                    ...
                    o = {};
                t || (t = {});
                for (i in u) (n = t[i]), (o[i] = null === n || void 0 === n ? u[i] : n);
                ...
                return (function(e, t) {
                    ...
                    (X = _e()),
                        (z = re
                            ? function(e, t) {
                                  var n = _e();
                                  (n.column += t), (n.offset += t), re.call(se, F[e], n, e);
                              }
                            : p),
                        pe--,
                        ce++;
                    for (; ++pe < ce; )
                        if ((B === m && (ge = de[ue] || 1), (B = e.charCodeAt(pe)) === E)) {
                            if (
                                (H = e.charCodeAt(pe + 1)) === g ||
                                H === m ||
                                H === f ||
                                H === b ||
                                H === E ||
                            ...
                            for (
                                Y = W = pe + 1,
                                    ...
                                    H === y
                                        ? ((J = ++Y),
                                          (H = e.charCodeAt(J)) === T || H === A ? ((K = R), (J = ++Y)) : (K = O))
                                        : (K = N),
                                    n = '',
                                    V = '',
                                    u = '',
                                    q = C[K],
                                    J--;
                                ++J < ce && ((H = e.charCodeAt(J)), q(H));

                            )
                                (u += c(H)), K === N && d.call(a, u) && ((n = u), (V = a[u]));
                            (o = e.charCodeAt(J) === _) && (J++, (i = K === N && l(u)) && ((n = u), (V = i))),
                                (Q = 1 + J - W),
                                (o || te) &&
                                    (u
                                        ? K === N
                                            ...
                                            : (o || z(k, Q),
                                              (G = parseInt(u, v[K])),
                                              ((Ee = G) >= 55296 && Ee <= 57343) || Ee > 1114111
                                                  ? (z(M, Q), (G = c(I)))
                                                  : G in r
                                                  ? (z(P, Q), (G = r[G]))
                                                  : ((j = ''),
                                ...
                                G
                                    ? (Se(),
                                      ...
                                      be.push(G),
                                      (Z = _e()).offset++,
                                      ae && ae.call(oe, G, {start: X, end: Z}, e.slice(W - 1, J)),
                                      (X = Z))
                                    : ((u = e.slice(W - 1, J)), (fe += u), (ge += u.length), (pe = J - 1));
                        } else 10 === B && (me++, ue++, (ge = 0)), B === B ? ((fe += c(B)), ge++) : Se();
                    var Ee;
                    return be.join('');
                    function _e() {
                        return {line: me, column: ge, offset: pe + (le.offset || 0)};
                    }
                    function Se() {
                        fe && (be.push(fe), ne && ne.call(ie, fe, {start: X, end: _e()}), (fe = ''));
                    }
                })(e, o);
            };
            ...
            (F[w] = 'Named character references must be terminated by a semicolon'),
                (F[k] = 'Numeric character references must be terminated by a semicolon'),
                (F[L] = 'Named character references cannot be empty'),
                (F[x] = 'Numeric character references cannot be empty'),
                (F[D] = 'Named character references must be known'),
                (F[P] = 'Numeric character references cannot be disallowed'),
                (F[M] = 'Numeric character references cannot be outside the permissible Unicode range');
        },
        ZZii: function(e, t, n) {
            function a(e) {
                !(function(e) {
        ...
        aIN1: function(e, t, n) {
            var a = n('q1tI'),
                ...
                o = n('1KBa'),
                s = r.a.createElement,
                l = i.default.footer.withConfig({displayName: 'footer__StyledFooter', componentId: 'co4dyq-0'})([
            ...
            t.a = () => s(l, null, s(d, null, s(o.a, {href: '/'}, 'yashsoni.com')));
        },
        aKgD: function(e, t, n) {
            function a(e) {
                e.languages.wasm = {
                    ...
                    (function(e) {
                        ...
                        (e.languages.javadoc = e.languages.extend('javadoclike', {})),
                            e.languages.insertBefore('javadoc', 'keyword', {
                                ...
                                'code-section': [
                                    {pattern: /(\{@code\s+)(?:[^{}]|\{[^{}]*\})+?(?=\s*\})/, lookbehind: !0, inside: t},
        ...
        hQuw: function(e, t, n) {
            ...
            (e.exports = r), (r.displayName = 'arduino'), (r.aliases = []);
        },
        'hR/J': function(e, t, n) {
            function a(e) {
            ...
            function a(e) {
                !(function(e) {
                    e.languages.pug = {
                        ...
                        code: [
                            {pattern: /(^[\t ]*(?:-|!?=)).+/m, lookbehind: !0, inside: {rest: e.languages.javascript}}
                        ],
                        punctuation: /[.\-!=|]+/
                    };
                    for (
            ...
            function a(e) {
                !(function(e) {
                    var t = {pattern: /\\[\\(){}[\]^$+*?|.]/, alias: 'escape'},
                        ...
                        s = [/\\(?![123][0-7]{2})[1-9]/, {pattern: /\\k<[^<>']+>/, inside: {'group-name': o}}];
                    (e.languages.regex = {
                        charset: {
                            pattern: /((?:^|[^\\])(?:\\\\)*)\[(?:[^\\\]]|\\[\s\S])*\]/,
                            lookbehind: !0,
                            inside: {
                                ...
                                'charset-punctuation': /^\[|\]$/,
                                range: {pattern: i, inside: {escape: n, 'range-punctuation': /-/}},
                                'special-escape': t,
                                charclass: a,
                                backreference: s,
                                escape: n
                        ...
                        ['actionscript', 'coffescript', 'flow', 'javascript', 'typescript', 'vala'].forEach(function(
                            t
                        ) {
                            var n = e.languages[t];
                            n &&
        ...
        qTn3: function(e, t, n) {
            ...
            function s(e, t, n, s) {
                var d,
                    c = -1;
                for (l(this, 'space', s), a.call(this, e, t); ++c < o; ) l(this, (d = i[c]), (n & r[d]) === r[d]);
            }
            function l(e, t, n) {
                n && (e[t] = n);
            }
            ...
            e.exports = function(e, t, n) {
                var r = n
                    ? (function(e) {
                          var t,
                              ...
                              a = -1,
                              r = {};
                          for (; ++a < n; ) (t = e[a]), (r[t.toLowerCase()] = t);
                          return r;
                      })(n)
                    : null;
                return function(e, n) {
                    ...
                    (o.tagName = r && l.call(r, d) ? r[d] : d),
                        n &&
                            ...
                            (s.unshift(n), (n = null));
                    if (n) for (a in n) c(o.properties, a, n[a]);
                    (function e(t, n) {
                        var a, r;
                ...
                function c(t, n, r) {
                    ...
                    null !== r &&
                        ...
                        (t[l] = (function(e, t, n) {
                            var a, r, i;
                            if ('object' !== typeof n || !('length' in n)) return d(e, t, n);
                            (r = n.length), (a = -1), (i = []);
                            for (; ++a < r; ) i[a] = d(e, t, n[a]);
                            return i;
                        })(i, l, c)));
                }
            };
        ...
        sFmL: function(e, t, n) {
            ...
            (e.exports = r), (r.displayName = 'objectivec'), (r.aliases = []);
        },
        sYQe: function(e, t, n) {
            var a = n('0iGP');
            function r(e) {
        ...
        'ul/r': function(e, t, n) {
            ...
            (e.exports = i), (i.displayName = 'opencl'), (i.aliases = []);
        },
        'v/u2': function(e, t, n) {
            function a(e) {
                !(function(e) {
                    ...
                    var a = '[-+*/_~!@$%^=<>{}\\w]+',
                        ...
                        l = {
                            ...
                            lookbehind: !0,
                            inside: {
                                'rest-vars': {pattern: RegExp('&(?:rest|body)\\s+' + s), inside: o},
                                'other-marker-vars': {pattern: RegExp('&(?:optional|aux)\\s+' + s), inside: o},
                                keys: {pattern: RegExp('&key\\s+' + s + '(?:\\s+&allow-other-keys)?'), inside: o},
                                argument: {pattern: RegExp(a), alias: 'variable'},
                                punctuation: /[()]/
                            }
                        };
        ...
        xK7a: function(e, t, n) {
            var a = n('7ljp'),
                ...
                s = n('vxfB'),
                l = n('1eME'),
                d = o.default.blockquote.withConfig({
                    displayName: 'blockquote__Blockquote',
                    componentId: 'sc-3d3qbm-0'
                })(
                    [
                        'color:#333;font-size:1em;font-style:italic;font-weight:500;letter-spacing:-0.012em;line-height:1.48;padding-left:50px;padding:',
                        ' ',
                        ';@media (min-width:768px){font-size:1.2em;}'
                    ],
                    l.b.small,
                    l.b.normal
                ),
            ...
            function _(e) {
                ...
                if (c) {
                    var u = (function(e, t) {
                        ...
                        S = m && m.length ? m : void 0,
                        h = o
                            ? f()(
                                  {},
                                  l,
                                  {className: S && E(S)},
                                  {style: b(l.className, Object.assign({}, l.style, r), n)}
                              )
                            : f()({}, l, {className: E(l.className)}),
                        y = u(t.children);
                    return i.a.createElement(c, g()({key: s}, h), y);
                }
            }
            var S = /\n/g;
            function h(e) {
                ...
                return (
                    (r.style = r.style || {float: 'left', paddingRight: '10px'}),
                    i.a.createElement(
                        'code',
                        g()({}, r, {style: Object.assign({}, n, r.style)}),
                        (function(e) {
                            var t = e.lines,
                            ...
                            return t.map(function(e, t) {
                                ...
                                return i.a.createElement(
                                    'span',
                                    g()({key: 'line-'.concat(t), className: 'react-syntax-highlighter-line-number'}, o),
                                    ''.concat(a, '\n')
                                );
                            });
                        })({lines: t.replace(/\n$/, '').split('\n'), numberProps: o, startingLineNumber: s})
                    )
                );
            }
            function y(e) {
                ...
                for (
                    var n = (function e(t) {
                            for (
                                ...
                                var i = t[r];
                                if ('text' === i.type) a.push(y({children: [i], className: n}));
                                else if (i.children) {
                                    var o = n.concat(i.properties.className);
                                    a = a.concat(e(i.children, o));
                                }
                            }
                            return a;
                        })(e.value),
                            ...
                            if (o.match(S)) {
                                ...
                                s.forEach(function(o, l) {
                                    ...
                                    if (0 === l) {
                                        var p = n
                                            .slice(r + 1, i)
                                            .concat(y({children: [c], className: e.properties.className}));
                                        a.push(y({children: p, lineNumber: d, lineProps: t}));
                    ...
                    o();
                if (r !== n.length - 1) {
                    var s = n.slice(r + 1, n.length);
                    s && s.length && a.push(y({children: s, lineNumber: a.length + 1, lineProps: t}));
                }
                return a;
            }
            function A(e) {
                var t = e.rows,
                    ...
                    a = e.useInlineStyles;
                return t.map(function(e, t) {
                    return _({node: e, stylesheet: n, useInlineStyles: a, key: 'code-segement'.concat(t)});
                });
            }
            var I,
                N,
                ...
                O =
                    ...
                    function(e) {
                        var t = e.language,
                            ...
                            s = void 0 === o ? {} : o,
                            l = e.codeTagProps,
                            d = void 0 === l ? {style: r['code[class*="language-"]']} : l,
                            c = e.useInlineStyles,
                            u = void 0 === c || c,
                            g = e.showLineNumbers,
                            m = void 0 !== g && g,
                            f = e.startingLineNumber,
                            b = void 0 === f ? 1 : f,
                            E = e.lineNumberContainerProps,
                            _ = e.lineNumberProps,
                            S = e.wrapLines,
                            y = e.lineProps,
                            R = void 0 === y ? {} : y,
                            ...
                            k = void 0 === w ? 'code' : w,
                            L = e.code,
                            x = void 0 === L ? (Array.isArray(n) ? n[0] : n) : L,
                            D = e.astGenerator,
                            P = p()(e, [
                                'language',
                                'children',
                        ...
                        var M = m
                                ...
                                : null,
                            F = r.hljs || r['pre[class*="language-"]'] || {backgroundColor: '#fff'},
                            U = u
                                ? Object.assign({}, P, {style: Object.assign({}, F, s)})
                                : Object.assign({}, P, {className: 'hljs'});
                        if (!D) return i.a.createElement(C, U, M, i.a.createElement(k, d, x));
                        (S = !(!O || void 0 !== S) || S), (O = O || A);
                        var B = [{type: 'text', value: x}],
                            G = (function(e) {
                                ...
                                try {
                                    return n && 'text' !== n ? {value: t.highlight(a, n)} : {value: r};
                                } catch (o) {
                                    return {value: r};
                                }
                            })({astGenerator: D, language: t, code: x, defaultCodeValue: B});
                        null === G.language && (G.value = B);
                        var H = S ? T(G, R) : G.value;
                        return i.a.createElement(
                            C,
                            U,
                            M,
                            i.a.createElement(k, d, O({rows: H, stylesheet: r, useInlineStyles: u}))
                        );
                    });
            ...
            var v = O,
                ...
                w = (e) => {
                    ...
                    return C(
                        v,
                        {language: e.language, style: {overflow: 'scroll'}, useInlineStyles: !1},
                        C(i.a.Fragment, null, t.children)
                    );
                };
            w.defaultProps = {language: 'jsx'};
            var k = w,
                L = o.default.em.withConfig({displayName: 'em__Em', componentId: 'sc-1wznvbk-0'})([
                    'font-style:italic;'
                ]),
                x = n('aIN1'),
                D = n('G0F+'),
                ...
                M = n('Ff2n'),
                F = i.a.createElement,
                U = o.default.img.withConfig({displayName: 'img__StyledImage', componentId: 'sc-1kifb3m-0'})(
                ...
                B = (e) => {
                    ...
                    return F(
                        U,
                        Object(P.a)({async: !0, decoding: 'async', importance: 'low', loading: 'lazy', src: t}, n)
                    );
                },
                G = o.default.li.withConfig({displayName: 'li__Li', componentId: 'sc-137jtm7-0'})(
                    ['color:', ';'],
                    (e) => e.theme.primary
                ),
                H = n('1KBa'),
                z = n('MbLX'),
                $ = o.default.ol.withConfig({displayName: 'ol__Ol', componentId: 'sc-3nwoxb-0'})(
                    ['margin:0 0 ', ' ', ';list-style-type:disc;p{margin-bottom:0;}'],
                    l.b.normal,
                    l.b.large
                ),
                j = n('PQhJ'),
                V = o.default.strong.withConfig({displayName: 'strong__Strong', componentId: 'sc-16c26b3-0'})([
                    'font-weight:bold;'
                ]),
                Y = o.default.ul.withConfig({displayName: 'ul__Ul', componentId: 'sc-1iyg7cd-0'})(
                    ['margin:0 0 ', ' ', ';list-style-type:disc;p{margin-bottom:0;}'],
                    l.b.normal,
                    l.b.large
                ),
                ...
                q = o.default.main.withConfig({displayName: 'post__Main', componentId: 'sc-9b2r0b-0'})(
                    ['', ' padding:', ';@media (min-width:768px){font-size:18px;}'],
                    s.a,
                    l.b.normal
                );
            t.a = (e) => {
                var {children: t, meta: n} = e;
                return W(
                    j.a,
                    {
                        date: n.date,
                        ...
                        image: n.image,
                        title: ''.concat(n.title, ' - Yash Soni')
                    },
                    W(z.a, null),
                    W(q, null, W(a.a, {components: K}, W('article', null, t)), W('hr', null)),
                    W(x.a, null)
                );
            };
        },
        ...
        z2ZG: function(e, t, n) {
            ...
            e.exports = function(e) {
                var t,
                    ...
                    s = [],
                    l = -1;
                for (; ++l < i; ) (t = e[l]), o.push(t.property), s.push(t.normal), (n = t.space);
