...
<MediaGrid
  photos={[
    { src: image_flashing1, width: 1600, height: 965 },
    { src: image_flashing2, width: 1600, height: 965 }
  ]}
...
<MediaGrid
  photos={[
    { src: image_ipScan, width: 1837, height: 1295 },
    { src: image_rpi_ssh, width: 1414, height: 1062 }
  ]}
