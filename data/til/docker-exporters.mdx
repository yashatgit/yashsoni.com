...
However, instead of copying the entire contents, we can use the [`scratch`](https://hub.docker.com/_/scratch)
...
Using this method, we can extract files generated in intermediatery stages without the need of copying to subsequent stages
and even creating temporary containers!
